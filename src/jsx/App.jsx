            ...
            <div className={style.left_container + ' ' + style.left_container_50} style={{paddingRight: '40px'}}>
              ...
              <ol>
                <li>
                  ...
                  <ul>
                    <li><strong>Must see:</strong> <a href="https://en.wikipedia.org/wiki/Church_of_la_Compa%C3%B1%C3%ADa_de_Jes%C3%BAs,_Quito">Compañía de Jesus</a>, San Francisco de Quito and Basílica del Voto National, <a href="https://www.tripadvisor.com/Attraction_Review-g294308-d1774138-Reviews-Calle_La_Ronda-Quito_Pichincha_Province.html">la Ronda</a> street.</li>
